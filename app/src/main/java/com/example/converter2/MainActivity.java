...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button buttonConvMilesToKm = findViewById(R.id.buttonConvMilToKm);
        ...
        Button buttonConvKmToMil = findViewById(R.id.buttonConvKmToMil);
        buttonConvKmToMil.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                EditText textBoxMiles = findViewById(R.id.editTextMiles);
                EditText textBoxKm = findViewById(R.id.editTextKm);
